...
namespace my_proj
{
    public partial class Sybsc : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String querry = "Select * from SyBscCs where RollNo ='" + RollNo.Text + "'";
                ...
                {
                    string strQuery = "insert into SyBscCs values(@Name, @RollNo, @PhoneNo, @Password, @Address, @Department)";
