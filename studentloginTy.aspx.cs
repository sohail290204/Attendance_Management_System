...
namespace my_proj
{
    public partial class studentloginTy : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    String querry = "Select * from TyBscCs where RollNo ='" + TextBox2.Text + "' and Password='" + TextBox1.Text + "'";
