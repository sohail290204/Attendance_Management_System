...
namespace my_proj
{
    public partial class TyBscCs : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String querry = "Select * from TyBscCs where RollNo ='" + RollNo.Text + "'";
                ...
                {
                    string strQuery = "insert into TyBscCs values(@Name, @RollNo, @PhoneNo, @Password, @Address, @Department)";
