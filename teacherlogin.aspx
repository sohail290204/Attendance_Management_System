<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacherlogin.aspx.cs" Inherits="my_proj.teacherlogin" %>
  ...
  #Button1:hover,#Button2:hover{
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <label id="uname" >Teacher Id</label>
            <br><br>
            <asp:TextBox ID="TextBox2" runat="server" placeholder="Enter your Id"></asp:TextBox>
            <br><br>
